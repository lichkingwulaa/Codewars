...
class Youku():
    def __init__(self):
        ...
        self.utid = urllib.quote('onBdERfZriwCAW+uM3cVByOa')
...
if __name__ == '__main__':
    # url_input = input("粘贴你想解析的优酷视频链接粘贴到此处，如:http://v.youku.com/v_show/id_XMTU2NTk5MDgxMg==.html,然后按回车键执行！" + '\n' + '>>>')
    # url_input='http://v.youku.com/v_show/id_XMTU3NTkxNDIwMA==.html'
    youku = Youku()
    
    youku.get_video_info('https://v.youku.com/v_show/id_XMjczMjA1Mjk2OA==.html?spm=a2h0j.11185381.module_basic_relationright.5~5!2~5~5!13~5~A')
    # youku.get_video_info('http://v.youku.com/v_show/id_XMTU2NTk5MDgxMg==.html')
